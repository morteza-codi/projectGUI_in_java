...
public class ClassInfo {
    ...
    public ClassInfo(String name, String type) {
        this.name = name;
        this.type = type;
        this.visibility = "package-private";
        this.isAbstract = false;
        this.attributes = new ArrayList<>();
        this.methods = new ArrayList<>();
    }
    
    public ClassInfo(String name, String type, String visibility, boolean isAbstract) {
        this.name = name;
        this.type = type;
        this.visibility = visibility != null ? visibility : "package-private";
